...
exports.Slide = props => {
    ...
    const layout = Object.assign({ backgroundColor: "#ffffff" }, props.layout);
    const onMainAction = () => {
        if (!action.link)
            return;
    ...
    return (react_1.default.createElement(antd_1.Layout, { style: {
        ...
        react_1.default.createElement(Content, { style: Object.assign(Object.assign({ display: 'flex', boxShadow: props.depth ? "0 0 10px #CCCCCC" : 0, justifyContent: "center", alignItems: "center" }, layout), { width: "100%", padding: 40, flexDirection: props.viewport.isSmall ? 'column' : 'row' }) },
