...
exports.Slide = props => {
    ...
    const renderAction = () => (react_1.default.createElement(antd_1.Button, { type: "primary", size: "large", onClick: onMainAction, style: {
            minWidth: 300,
    ...
    return (react_1.default.createElement(antd_1.Layout, { style: {
        ...
        react_1.default.createElement(Content, { style: Object.assign(Object.assign({ display: 'flex', boxShadow: props.depth ? "0 0 10px #CCCCCC" : 0, justifyContent: "center", alignItems: "center" }, layout), { width: "100%", flexDirection: props.viewport.isSmall || horizontal ? 'column' : 'row' }) },
...
exports.SlideSet = props => {
    ...
    return (react_1.default.createElement("div", { style: {
            ...
            width: "100%",
            flexDirection: "column"
        } }, slides.map((slide, i) => (react_1.default.createElement(exports.Slide, Object.assign({ key: `${i}` }, slide, props))))));
};
