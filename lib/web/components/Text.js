...
exports.Text = props => {
    ...
    return (react_1.default.createElement(antd_1.Layout, { style: Object.assign({ width: "100%", alignItems: "center", justifyContent: "center" }, props.layout || {}) },
        react_1.default.createElement(Content, { style: Object.assign({ backgroundColor: "#ffffff", color: props.theme.colors.text, padding: 40 }, props.layout || {}) }, text ? react_1.default.createElement(react_markdown_1.default, { source: text, renderers: renderers(props), plugins: plugins })
