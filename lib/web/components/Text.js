...
exports.Text = props => {
    ...
    return (react_1.default.createElement(antd_1.Layout, { style: {
        ...
        react_1.default.createElement(Content, { style: Object.assign({ color: props.theme.colors.text, padding: isPost ? 10 : 40, marginTop: isPost ? 20 : 0, backgroundColor: "#ffffff", width: "100%" }, props.layout || {}) }, renderMarkdown())));
};
