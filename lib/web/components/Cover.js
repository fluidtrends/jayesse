...
exports.Cover = function (props) {
    var title = props.title, image = props.image, assets = props.assets, subtitle = props.subtitle, action = props.action;
    ...
    var coverImage = cover(image) + "/" + (isPortrait ? 'portrait' : 'landscape') + "@" + scale + "x.png";
    var coverPlaceholder = cover(image) + "/placeholder.png";
