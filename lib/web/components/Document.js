...
exports.Document = react_router_dom_1.withRouter(function (props) {
    ...
    return (react_1.default.createElement(antd_1.Layout, { style: { width: "100%" } },
        react_1.default.createElement(react_responsive_1.default, { minWidth: 768 }, sections ? react_1.default.createElement(_1.SideMenu, __assign({}, props, { selected: selected, items: sections, onSelect: onSelect }))
