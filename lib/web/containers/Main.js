...
exports.Main = props => {
    ...
    const renderHeader = () => (react_1.default.createElement(components_1.Header, Object.assign({}, props, { current: props.id }, props.header, { cover: props.cover, items: props.routes })));
    const renderContent = () => (react_1.default.createElement(Content, { style: styles.layouts.content }, props.children));
