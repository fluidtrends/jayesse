 ...
 * @param route
 */
var renderRoute = function (route) { return (react_1.default.createElement(react_router_dom_1.Route, { path: route.path, render: function (props) { return (react_1.default.createElement(route.component, __assign({}, props, { routes: route.routes }))); } })); };
