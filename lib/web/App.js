...
exports.App = (props) => {
    ...
    const Container = (route) => {
        ...
        return (react_1.default.createElement(Cont, Object.assign({}, props, route), route.components.map((component, i) => renderComponent(component, i))));
    };
    const renderRoute = (route) => {
        ...
        return react_1.default.createElement("div", null,
            react_1.default.createElement(Container, Object.assign({ key: "container" }, route)));
    };
