...
export declare const cover: (base: string, locale: string, id: string) => string;
export declare const images: (base: string, locale: string) => any;
export declare const covers: (base: string, locale: string) => any;
